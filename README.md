...
3.  Скопируйте в него следующий «стандарт» кода подключения:
...
Все должны создать в VS Code файл **`register.php`** и поместить в него следующий **полный код**.

Обратите внимание: в фрагмент добавивлено:
